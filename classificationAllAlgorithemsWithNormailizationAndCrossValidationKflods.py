...
# standaralized_x=preprocessing.scale(X)
...
for name, model in models:
	...
	results.append(accuracy_score(Y, y_predict))
	# results.append(accuracy_score(Y_validation, y_predict.round(),normalize=False))
	results.append(classification_report(Y, y_predict))
	results.append(confusion_matrix(Y,y_predict))
